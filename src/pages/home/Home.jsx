        ...
        <div className="background">
          <div className="foward">
            <div>
              ...
              <p className="pagetext">Te damos la bienvenida a la página de Duel Bar. En nuestra página podrás encontrar toda información de tu interés relacionada a nosotros, como nuestro catálogo, usuarios frecuentes, y más información. Todo sea por encontrar con quién combatir, mejorar nuestro nivel, saborear la victoria y una buena comida, y sobre todo disfrutar y aprender con nuestros duelos, ya sea con viejos amigos o con nuevos rivales por conocer en nuestro camino.</p>
            </div>
            <div>
